                    ...
                    <div class="card-body">
                        ...
                        <form id="editarClienteForm" class="form-horizontal m-t-30">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese el nombre del cliente" value="<?php echo $nombre; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="apellido_paterno" class="col-sm-12">Apellido Paterno</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno" placeholder="Ingrese el apellido paterno del cliente" value="<?php echo $apellido_paterno; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="apellido_materno" class="col-sm-12">Apellido Materno</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" placeholder="Ingrese el apellido materno del cliente" value="<?php echo $apellido_materno; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="celular" name="celular" placeholder="Ingrese el celular del cliente" value="<?php echo $celular; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="email" class="col-sm-12">Email</label>
                                <div class="col-sm-12">
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Ingrese el email del cliente" value="<?php echo $email; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="referencia" name="referencia" placeholder="Ingrese la referencia del cliente" value="<?php echo $referencia; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
