                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" id="id_cliente" name="id_cliente" required>
                                                <?php
                                                $stmt = $pdo->prepare("SELECT id_cliente, nombre, dni_ruc FROM clientes");
                                                $stmt->execute();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" id="id_planes_servicios" name="id_planes_servicios" required>
                                                ...
                                                <?php
                                                $stmt = $pdo->prepare("SELECT id_plan_servicio, nombre_plan, tarifa_mensual, velocidad FROM planes_servicio WHERE estado = 1");
                                                $stmt->execute();
                                                while ($fila = $stmt->fetch()) {
                                                    echo "<option value='" . $fila['id_plan_servicio'] . "' data-precio='" . $fila['tarifa_mensual'] . "' data-velocidad='" . $fila['velocidad'] . "' >" . $fila['nombre_plan'] . " - S/." . $fila['tarifa_mensual'] . " - Velocidad: " . $fila['velocidad'] ."MB". "</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
